...
export const onpeResultsImagePayloadSchema = z
	.object({
...
export type OnpeResultsImagePayload = z.infer<
	typeof onpeResultsImagePayloadSchema
>;
export type OnpeSnapshotEntry = z.infer<
	typeof onpeSnapshotSchema
>["data"][number];
